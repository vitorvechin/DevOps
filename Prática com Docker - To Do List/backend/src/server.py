...
async def create_todo_list_item(list_id: str, new_item: NewItem) -> ToDoList:
    return await app.todo_dal.create_todo_list_item(list_id, new_item.label)

@app.delete("/api/lists/{list_id}/items/{item_id}")
async def delete_todo_list_item(list_id: str, item_id: str) -> ToDoList:
...
async def set_checked(list_id: str, item: ToDoItemUpdate) -> ToDoList:
